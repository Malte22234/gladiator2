...
if (Gandalf1==1 and spelarens_val == "b"):
    ...
    print("din motståndare valde attack b och du valde attack c. han förlorar 1 hp ")
    robot_hp=robot_hp - 1
elif(Gandalf1==1 and spelarens_val == "a"):
    print ("din motståndare valde attack a och du valde attack a. ingen förlorar hp")
elif(Gandalf1==2 and spelarens_val == "b"):
    print("din motståndare valde attack b och vald attack ingen tar skada")
elif(Gandalf1==3 and spelarens_val == "b"):
    print("din motståndare valde attack c och du valde attack b. han tar skada")
    robot_hp=robot_hp-1
elif(Gandalf1==1 and spelarens_val == "c"):
    print("din motståndare valde attack a och du valde attack c. han tar skada")
    robot_hp=robot_hp-1
elif(Gandalf1==3 and spelarens_val == "a"):
    print("din motståndare valde attack c och du valde attack a. han tar skada")
    robot_hp=robot_hp-1
